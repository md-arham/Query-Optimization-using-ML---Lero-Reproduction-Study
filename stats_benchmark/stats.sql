...
<!--[if (gte IE 10)|!(IE)]><!--><html lang="cs" class="no-js"> <!--<![endif]-->
	...
	<title>Projekt Relational - FIT ČVUT</title>
...
<meta property="og:title" content="Projekt Relational" />
<meta property="twitter:title" content="Projekt Relational" />
<meta property="og:description" content="FIT ČVUT" />
<meta property="twitter:description" content="FIT ČVUT" />
<meta property="og:url" content="http://fit.cvut.cz/cs/veda-a-vyzkum/cemu-se-venujeme/projekty/relational/" />
...
<div class="subdropdown" id="uchazeci-dropdown-box-0">
			...
			Důležité termíny, podmínky přijetí, postupy a návody.
                                        ...
                                        <a href="/cs/uchazeci/prijimaci-rizeni" internalType="document" linktype="internal" text="Přijímací řízení" path="/cs/uchazeci/prijimaci-rizeni" class="btn btn-simple" internalId="89">Přijímací řízení</a>
			...
			Firmy zvučných jmen i ty méně známé, nadnárodní giganti i české společnosti.
                ...
                <ul class="quicklinks-mobile-list">
                      ...
                      <a href="https://intranet.fit.cvut.cz/" linktype="direct" text="Intranet" path="https://intranet.fit.cvut.cz/" target="_blank _blank">Intranet <svg class="icon icon-external m-l-0-25"><use xlink:href="/static/svg/svg-sprite.svg#icon-external"/></svg></a>
							...
							<a href="/cs/veda-a-vyzkum/cemu-se-venujeme/projekty/relational" class="lng-mobile  active" title="CZ" target="_self">
					CZ
				</a>
		...
		<li class="lng-switch-wrap">
			...
			<div class="dropdown dropdown-lng" id="jazyk-dropdown">
				<ul class="dropdown-nav">
							...
							<li>
					<a href="/cs/veda-a-vyzkum/cemu-se-venujeme/projekty/relational" class="lng" title="CZ" target="_self">
						CZ
					</a>
				</li>
					...
					<ul>
									...
									<a itemprop="item" href="/cs" title="Úvod" target="_self">
										...
										<meta itemprop="position" content="1">
																													...
																													<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
									<a itemprop="item" href="/cs/veda-a-vyzkum" title="Věda a výzkum" target="_self">
										<span itemprop="name">
											Věda a výzkum
										</span>
										<meta itemprop="position" content="2">
																													...
																													<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
									<a itemprop="item" href="/cs/veda-a-vyzkum/cemu-se-venujeme" title="Čemu se věnujeme" target="_self">
										<span itemprop="name">
											Čemu se věnujeme
										</span>
										<meta itemprop="position" content="3">
																													...
																													<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
									<a itemprop="item" href="/cs/veda-a-vyzkum/cemu-se-venujeme/projekty" title="Projekty" target="_self">
										<span itemprop="name">
											Projekty
										</span>
		...
		<div class="container article">
					...
					<div class="col-lg-8 offset-lg-2">
						<div class="perex entry">
							<p style="text-align:center;"><a href="https://relational-data.org/" target="_blank"><img src="/veda-a-vyzkum/projekty/relational.png" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);" width="800" /></a><br />
<br />
From 2024-04-05 onward, use<br />
<a href="https://relational-data.org/" rel="noopener noreferrer" target="_blank">relational-data.org</a><br />
or<br />
<a href="https://relational.fel.cvut.cz/" rel="noopener noreferrer" target="_blank">relational.fel.cvut.cz</a></p>
			...
			<div class="row">
				<div class="col-12 text-center">
					<p>
						...
						<a href="/cs/fakulta/lide/5367-stepan-starosta" title="doc. Ing. Štěpán Starosta, Ph.D." target="_self">
...
<footer class="footer">
	<div class="container">
		...
		<!-- JS -->
					...
					<script src="/cache-buster-1761056001/static/js/scripts.min.js" nonce="rwV46PCVlK3gk3JUmAT5PmNulebOJf3r"></script>
